...
dat.surv.all %>% # tally the percentage "just right" by building
  select(murb,Pre_S_warm:Post_W_DK) %>%
  group_by(murb,Pre_W_just.right) %>%
  
  mutate_at(vars(c("Pre_S_just.right","Post_W_just.right")),funs("percent"=./sum(.)))
