...
dat.surv.all <-
    ...
    mutate ( # Create a column that is a factor for all summer thermal comfort pre-retrofit
        Pre_S_tally = as.factor(
                        case_when(
                            Pre_S_warm == 1 ~ "Too warm in summer",
                            Pre_S_just.right == 1 ~ "Just right in summer",
                            Pre_S_cold == 1 ~ "Too cold in summer",
                            Pre_S_DK == 1 ~ "Don't know"))) %>%
    mutate ( # Create a column that is a factor for all summer thermal comfort post-retrofit
        Post_S_tally = as.factor(
                        case_when(
                            Post_S_warm == 1 ~ "Too warm in summer",
                            Post_S_just.right == 1 ~ "Just right in summer",
                            Post_S_cold == 1 ~ "Too cold in summer",
...
dat.surv.all <-
    ...
    mutate ( # Create a new column for respondants that "are just right "Don't know", in the summer
        Post_W_DK= case_when( 
            ...
            TRUE ~ 0)) %>%  # Add Zeros to rest
    mutate ( # Create a column that is a factor for all summer thermal comfort pre-retrofit
        Pre_W_tally = as.factor(
                        case_when(
                            Pre_W_warm == 1 ~ "Too warm in summer",
                            Pre_W_just.right == 1 ~ "Just right in summer",
                            Pre_W_cold == 1 ~ "Too cold in summer",
                            Pre_W_DK == 1 ~ "Don't know"))) %>%
    mutate ( # Create a column that is a factor for all summer thermal comfort post-retrofit
        Post_W_tally = as.factor(
                        case_when(
                            Post_W_warm == 1 ~ "Too warm in summer",
                            Post_W_just.right == 1 ~ "Just right in summer",
                            Post_W_cold == 1 ~ "Too cold in summer",
